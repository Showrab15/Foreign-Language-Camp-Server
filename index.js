...
async function run() {
    try {
        ...
        const usersCollection = client.db("foreignLanguageCamp").collection("users");
        const addClassesCollection = client.db("foreignLanguageCamp").collection("addClasses");
        const selectedClassCollection = client.db("foreignLanguageCamp").collection("selectedClassCollection");
        const paymentCollection = client.db("foreignLanguageCamp").collection("paymentCollection");
        const enrolledClassCollection = client.db("foreignLanguageCamp").collection("enrolledClassCollection");
